...
class HorariosAdapterCiano(private var models: List<HorariosModel>, private var context: Context) : PagerAdapter() {
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater.inflate(R.layout.itemciano, container, false)
